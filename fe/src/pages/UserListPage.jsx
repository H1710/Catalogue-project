        ...
        <tbody>
          <tr class="border-y hover:bg-gray-300">
            <th class="p-2 text-white">
              <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-white border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-800 dark:border-gray-600" />
            </th>
            <td class="p-2">
