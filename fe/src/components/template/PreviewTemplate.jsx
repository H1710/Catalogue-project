...
import { acceptTemplateRoute, rejectTemplateRoute, updateClassTemplateRoute } from "../../utils/APIRoute";
...
const selectRef = useRef(0);
  ...
  const { mutate: updateClassService, isLoading: loadingUpdateClassService } = useMutation({
    mutationFn: (info) => {
      ...
      >
        ...
        <div className="w-full">
          ...
          <div className="my-4 text-sm">
            <label  htmlFor="Class Service" className="block text-black">Class service</label>
            <select
        ref={selectRef}
        defaultValue={0}
